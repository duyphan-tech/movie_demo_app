...
class Insets {
  ...
  // Symmetric
  static const EdgeInsets hSm = EdgeInsets.symmetric(horizontal: SpacingTokens.sm);
  static const EdgeInsets hMd = EdgeInsets.symmetric(horizontal: SpacingTokens.md);
  static const EdgeInsets hLg = EdgeInsets.symmetric(horizontal: SpacingTokens.lg);
  static const EdgeInsets vSm = EdgeInsets.symmetric(vertical: SpacingTokens.sm);
  static const EdgeInsets vMd = EdgeInsets.symmetric(vertical: SpacingTokens.md);
  static const EdgeInsets vLg = EdgeInsets.symmetric(vertical: SpacingTokens.lg);
