...
@override
String toString() {
  return 'AuthorDetailsModel(name: $name, username: $username, avatarPath: $avatarPath, rating: $rating)';
}
...
class _AuthorDetailsModel implements AuthorDetailsModel {
  const _AuthorDetailsModel({this.name, this.username, @JsonKey(name: 'avatar_path') this.avatarPath, this.rating});
